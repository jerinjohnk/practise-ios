...
class ProfileController: UIViewController {
    ...
    func configureBarStackView() {
        ...
        barStackView.anchor(top: view.safeAreaLayoutGuide.topAnchor, left: view.safeAreaLayoutGuide.leftAnchor, right: view.safeAreaLayoutGuide.rightAnchor, paddingTop: 8, paddingLeft: 8, paddingRight: 8, height: 4)
    }
