...
class BottomControlsStackView: UIStackView {
    ...
    override init(frame: CGRect) {
        ...
        refreshButton.imageView?.contentMode = .scaleAspectFill
        dislikeButton.imageView?.contentMode = .scaleAspectFill
        superLikeButton.imageView?.contentMode = .scaleAspectFill
        likeButton.imageView?.contentMode = .scaleAspectFill
        boostButton.imageView?.contentMode = .scaleAspectFill
